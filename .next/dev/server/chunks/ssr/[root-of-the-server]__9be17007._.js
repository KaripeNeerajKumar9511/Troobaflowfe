...
function DashboardSidebar() {
    ...
    const handleLogout = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/api/logout/");
        } catch  {
        // no-op
        } finally{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$csrf$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearCSRFToken"])();
            router.push("/login");
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    model && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
"[project]/src/lib/scenarioDb.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/stores/scenarioStore.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const uid = ()=>crypto.randomUUID();
const useScenarioStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        scenarios: [],
        families: [],
        ...
        loadScenariosFromDb: async (modelId)=>{
            ...
            const { loadScenariosForModel } = await __turbopack_context__.A("[project]/src/lib/scenarioDb.ts [app-ssr] (ecmascript, async loader)");
            ...
            const { useResultsStore } = await __turbopack_context__.A("[project]/src/stores/resultsStore.ts [app-ssr] (ecmascript, async loader)");
            ...
            const { loadBasecaseResults } = await __turbopack_context__.A("[project]/src/lib/scenarioDb.ts [app-ssr] (ecmascript, async loader)");
        ...
        createScenario: async (modelId, name, description = '')=>{
            const dbId = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scenarioDb"].create(modelId, name, description);
            const id = dbId || uid();
            const scenario = {
                id,
                modelId,
        ...
        duplicateScenario: async (id)=>{
            ...
            const dbId = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scenarioDb"].create(source.modelId, newName, source.description);
            ...
            dup.changes = dup.changes.map((c)=>{
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scenarioDb"].upsertChange(newId, newChange);
                return newChange;
            });
            set((s)=>({
                    scenarios: [
        ...
        renameScenario: (id, name)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scenarioDb"].update(id, {
                name
            });
        },
        ...
        deleteScenario: (id)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scenarioDb"].delete(id);
        },
        addChange: (scenarioId, change)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scenarioDb"].upsertChange(scenarioId, newChange);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scenarioDb"].update(scenarioId, {
                status: 'needs_recalc'
            });
        },
        updateChange: (scenarioId, changeId, whatIfValue)=>{
            ...
            if (updatedChange) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scenarioDb"].upsertChange(scenarioId, updatedChange);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scenarioDb"].update(scenarioId, {
                    status: 'needs_recalc'
                });
            }
        ...
        removeChange: (scenarioId, changeId)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scenarioDb"].removeChange(scenarioId, changeId);
        },
        applyScenarioChange: (scenarioId, dataType, entityId, entityName, field, fieldLabel, whatIfValue)=>{
            ...
            if (existing) {
                ...
                const model = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$modelStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useModelStore"].getState().getActiveModel();
                if (!model) return;
                let basecaseValue = '';
                if (dataType === 'Labor') {
        ...
        promoteToBasecase: (scenarioId)=>{
            const scenario = get().scenarios.find((s)=>s.id === scenarioId);
            if (!scenario) return;
            const modelStore = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$modelStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useModelStore"].getState();
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$backendClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scenarioDb"].delete(scenarioId);
        },
        // ── Family management ──
...
"[project]/src/components/dashboard/WorkspaceHeader.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function WorkspaceHeader({ children }) {
    ...
    const activeScenario = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$scenarioStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useScenarioStore"])((s)=>s.scenarios.find((sc)=>sc.id === s.activeScenarioId));
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            activeScenarioId && activeScenario ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$WorkspaceHeader$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/dashboard/WorkspaceHeader.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
function DashboardLayout({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$WorkspaceHeader$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WorkspaceHeader"], {}, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$Sidebar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DashboardSidebar"], {}, void 0, false, {
                        fileName: "[project]/src/components/dashboard/DashboardLayout.tsx",
                        lineNumber: 19,
                        columnNumber: 9
                    }, this),
...
"[project]/src/app/dashboard/DashboardHydration.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9be17007._.js.map