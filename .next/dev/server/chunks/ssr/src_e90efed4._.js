module.exports = [
"[project]/src/hooks/useSortableTable.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useSortableTable(data, defaultSortKey, defaultSortDir = 'desc') {
    ...
    const handleSort = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((key)=>{
        setSort((prev)=>{
    ...
    const reset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>setSort({
            key: '',
            dir: 'default'
        }), []);
    return {
...
"[project]/src/hooks/useRunCalculation.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useRunCalculation() {
    ...
    const setRunStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$modelStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useModelStore"])((s)=>s.setRunStatus);
    ...
    const activeScenario = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$scenarioStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useScenarioStore"])((s)=>s.getActiveScenario());
    const markCalculated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$scenarioStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useScenarioStore"])((s)=>s.markCalculated);
    const { setResults } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$resultsStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useResultsStore"])();
    ...
    const [verifyMessages, setVerifyMessages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    // Subscribe to shared state (getServerSnapshot required for SSR/prerender)
    const runLog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSyncExternalStore"])(subscribeRunLog, getRunLogSnapshot, ()=>[]);
    const isRunning = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSyncExternalStore"])(subscribeIsRunning, getIsRunningSnapshot, ()=>false);
    const handleRun = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (mode)=>{
        if (!model || _isRunning) return;
        // Verify-only mode
        if (mode === 'verify') {
            const startTime = Date.now();
            const msgs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$calculationEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["verifyData"])(model);
            ...
            if (msgs.errors.length === 0 && msgs.warnings.length === 0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Data verification complete — no issues found');
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].warning(`Found ${msgs.errors.length} error(s) and ${msgs.warnings.length} warning(s)`);
            }
            return;
        }
        // Validation
        ...
        if (validationErrors.length > 0) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`${validationErrors.length} validation error(s) — fix before calculating`, {
        ...
        return new Promise((resolve, reject)=>{
            const runCalculation = async ()=>{
                try {
                    let calcResults;
                    if (mode === 'full') {
                        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/simulations/full-calculate', {
                            model,
                            scenario: runScenario ?? null
                        });
                        calcResults = data.results;
                    } else {
                        calcResults = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$calculationEngine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculate"])(model, runScenario || undefined);
                    }
                    ...
                    notifyRunLog();
                    // Persist to Supabase
                    const { scenarioDb } = await __turbopack_context__.A("[project]/src/lib/scenarioDb.ts [app-ssr] (ecmascript, async loader)");
                    if (runScenario) {
                        scenarioDb.saveResults(runScenario.id, calcResults);
                    } else {
                        scenarioDb.saveBasecaseResults(model.id, calcResults);
                    }
                    const { db } = await __turbopack_context__.A("[project]/src/lib/supabaseData.ts [app-ssr] (ecmascript, async loader)");
                    db.updateModel(model.id, {
                        run_status: 'current',
                        last_run_at: new Date().toISOString()
                    });
                    if (hasErrors) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(calcResults.errors[0]);
                    } else if (hasWarnings) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].warning(`${calcResults.overLimitResources.length} resource(s) exceed utilization limit`);
                    } else {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(mode === 'full' ? 'Full calculation complete — all production targets achievable' : 'Utilization calculation complete');
                    }
                    resolve();
                } catch (err) {
                    setGlobalIsRunning(false);
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(String(message));
                    reject(err);
                }
            };
...
"[project]/src/lib/scenarioColors.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/calculationEngine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_e90efed4._.js.map