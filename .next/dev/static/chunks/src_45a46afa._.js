...
"[project]/src/app/dashboard/generaldata/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GeneralData() {
    ...
    const model = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$modelStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModelStore"])({
        "GeneralData.useModelStore[model]": (s)=>s.getActiveModel()
    }["GeneralData.useModelStore[model]"]);
    const updateGeneral = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$modelStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModelStore"])({
        "GeneralData.useModelStore[updateGeneral]": (s)=>s.updateGeneral
    }["GeneralData.useModelStore[updateGeneral]"]);
    ...
    const activeScenarioId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$scenarioStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScenarioStore"])({
        "GeneralData.useScenarioStore[activeScenarioId]": (s)=>s.activeScenarioId
    }["GeneralData.useScenarioStore[activeScenarioId]"]);
    const activeScenario = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$scenarioStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScenarioStore"])({
        "GeneralData.useScenarioStore[activeScenario]": (s)=>s.scenarios.find({
                "GeneralData.useScenarioStore[activeScenario]": (sc)=>sc.id === s.activeScenarioId
            }["GeneralData.useScenarioStore[activeScenario]"])
    }["GeneralData.useScenarioStore[activeScenario]"]);
    const applyScenarioChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$scenarioStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScenarioStore"])({
        "GeneralData.useScenarioStore[applyScenarioChange]": (s)=>s.applyScenarioChange
    }["GeneralData.useScenarioStore[applyScenarioChange]"]);
    // Capture saved unit values on mount — labels only update on remount, not live
    const savedUnitsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Model general data saved');
        } catch (e) {
            console.error('Save general data error:', e);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to save model general data');
        } finally{
            setSaving(false);
        }
    };
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: [
                                                                        ...
                                                                        g.conv1 <= 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: [
                                                                        ...
                                                                        g.conv2 <= 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            className: "text-xs text-destructive mt-1",
                                                                            children: "Must be greater than 0"
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/src/app/dashboard/generaldata/page.tsx",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            children: [
                                                                ...
                                                                (g.util_limit < 1 || g.util_limit > 99.9) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    className: "text-xs text-destructive mt-1",
...
_s(GeneralData, "9gsBK2Duadddi/0f9FVXlGxZwTg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$modelStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModelStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$modelStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useModelStore"],
...
__turbopack_context__.k.register(_c1, "GeneralData");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_45a46afa._.js.map