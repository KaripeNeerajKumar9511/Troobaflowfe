  ...
  return (
    <div className="animate-fade-in">
      {activeScenarioId && activeScenario && (
        <div className="mb-4 flex items-center gap-2 p-2.5 bg-amber-50 border border-amber-200 rounded-lg">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-slate-900">Operations & Routing</h1>
          <p className="text-sm text-slate-500">
            Define operations and routing flow per product
          </p>
        </div>
      ...
      {!effectiveProduct ? (
        ...
        <div className="space-y-4 mt-4">
            ...
            <div className="flex items-center justify-between gap-3 px-4 py-3 rounded-md bg-red-500/10 border border-red-500/30">
              ...
              <div className="flex gap-2">
                ...
                <Button variant="destructive" size="sm" onClick={async () => {
                  ...
                  try {
                    await db.clearProductOperationsAndRouting(model.id, effectiveProductId);
                    // Update local state
          ...
          <Card className={activeScenarioId ? 'border-0 border-l-[1px] border-l-amber-200 bg-white shadow-sm' : 'border-0 bg-white shadow-sm'}>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-xs text-slate-500">
                    {userOps.length} operations defined
                  </CardDescription>
                </div>
                <div className="flex items-center gap-2">
                  <Button
