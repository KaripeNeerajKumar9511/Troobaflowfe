...
export default function GeneralData() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      await db.updateGeneral(model.id, model.general);
      setIsDirty(false);
      setJustSaved(true);
      toast.success('Saved');
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <NonNegativeNumericInput allowDecimal value={g.var_equip} onChange={(v) => update({ var_equip: v })} className="mt-1.5 text-right" />
                </div>
                <div>
                  ...
                  <NonNegativeNumericInput allowDecimal value={g.var_labor} onChange={(v) => update({ var_labor: v })} className="mt-1.5 text-right" />
                </div>
                <div>
                  ...
                  <NonNegativeNumericInput allowDecimal value={g.var_prod} onChange={(v) => update({ var_prod: v })} className="mt-1.5 text-right" />
                </div>
              </div>
            </CardContent>
          </Card>
