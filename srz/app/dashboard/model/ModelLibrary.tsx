      ...
      {duplicatingModelId && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90">
          <div className="flex flex-col items-center justify-center px-6 py-12 text-center">
            ...
            <p className="mt-6 font-mono text-xs uppercase tracking-[0.2em] text-white/90">
              Duplicating model
            </p>
            <p className="mt-2 max-w-xs text-sm text-white/75 animate-pulse">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" className="gap-1" onClick={() => importRef.current?.click()} disabled={!!jsonTransfer}>
                <Upload className="h-4 w-4" /> {jsonTransfer === 'import' ? 'Importing…' : 'Import'}
              </Button>
              <Button onClick={() => setShowCreate(true)} className="gap-2">
                <Plus className="h-4 w-4" /> New Model
              </Button>
              {/* Interface level disabled: <UserLevelChip /> */}
