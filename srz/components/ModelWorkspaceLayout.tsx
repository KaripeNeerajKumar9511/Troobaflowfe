...
// Interface level gating disabled.
...
// Map route segments to their gating feature (null = always visible) — disabled.
...
export function ModelWorkspaceLayout() {
  ...
  // Interface level route gating disabled — all screens accessible.
  // useEffect(() => {
