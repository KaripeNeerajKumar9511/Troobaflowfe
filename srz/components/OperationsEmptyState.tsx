...
export function OperationsEmptyState({ productName, onAddOperations, disabled }: OperationsEmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-8 text-center">
      ...
      <Button className="gap-1.5" onClick={onAddOperations} disabled={disabled}>
