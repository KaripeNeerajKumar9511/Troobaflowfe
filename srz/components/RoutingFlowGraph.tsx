...
export const RoutingFlowGraph = forwardRef<RoutingFlowGraphHandle, Props>(function RoutingFlowGraph({ operations, routing, onLayoutChange }, ref) {
  ...
  return (
    ...
    >
      {dragging && (
        <div className="pointer-events-none absolute left-2 top-2 z-10 rounded-md border border-[#99F6E4] bg-white/95 px-2.5 py-1.5 text-[11px] font-medium text-[#0F766E] shadow-sm">
