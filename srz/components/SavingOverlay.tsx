...
export type SavingOverlayProps = {
  /** Uppercase label under spinner (portal style). */
  title?: string;
  /** Secondary line below title. */
  subtitle?: string;
};

/** Full-screen saving UI (same visual language as model duplicate / JSON transfer in Model Library). */
export function SavingOverlay({
  title = 'Saving',
  subtitle = 'Writing your changes…',
}: SavingOverlayProps) {
  return (
    <div
