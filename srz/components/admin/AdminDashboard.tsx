...
import { Users, Database, ArrowRight, Building2 } from 'lucide-react';
...
export function AdminDashboard() {
  ...
  return (
    <div className="p-6 max-w-5xl animate-fade-in">
      ...
      <p className="text-sm text-muted-foreground mb-6">Platform overview and quick access to organizations.</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Card
          ...
          role="button"
          tabIndex={0}
          onKeyDown={(e) => e.key === 'Enter' && navigate('/TF-admin/organizations')}
        >
